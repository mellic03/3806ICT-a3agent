...
static std::vector<ros::Publisher>  motors_pub        (a3env::NUM_AGENTS);
static ros::Publisher  deactivate_pub;
...
int main( int argc, char **argv )
{
    ...
    deactivate_pub = n.advertise<a3env::deactivate>("/a3env/deactivate", 8);
    ...
    for (int i=0; i<a3env::NUM_AGENTS; i++)
    {
        ...
        motors_pub[i]   = n.advertise<a3env::motors>(label0, 64);
        ...
        agents[i] = Agent(i, &plan_client, &motors_pub[i], &deactivate_pub);
    }
